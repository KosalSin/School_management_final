...
<div class="card" style="margin: 0px auto; width: 30rem; padding: 40px;">
    <h3 style="text-align:center; font-weight: bold;">Add New User</h3>
    <form method="post" action="{{url('/users/store')}}">
        @csrf
        <div class="form-group">
            <label for="inputName">First Name</label>
            <input type="string" class="form-control @error('first_name') is-invalid @enderror" id="first_name" name="first_name" placeholder="First Name">
            @error('first_name')
        ...
        <div class="form-group">
            ...
            <input type="string" class="form-control @error('last_name') is-invalid @enderror" id="last_name" name="last_name" placeholder="Student Name">
            @error('last_name')
            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
            @enderror
        </div>
